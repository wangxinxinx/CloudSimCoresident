...
import org.iie.cloudsim.drlallocation.AttackMonitor;
...
//	private boolean firstSubmitCloudlet = true;//wang
	/**
	...
	public void processEvent(SimEvent ev) {
		...
		// Resource characteristics inquiry
			...
			case CloudSimTags.VM_DATACENTER_EVENT:
				...
				break;
			case CloudSimTags.SCAN_VM_THREAT_SCORE://wang
				updateVmsThreatScore();//wang
				break;//wang
	...
	//wang
	private void updateVmsThreatScore() {
		AttackMonitor.updateVmsThreatScore();
		
		schedule(getId(),DrlConstants.SCAN_VM_THREAT_SCORE_INTERVAL, CloudSimTags.SCAN_VM_THREAT_SCORE);
	}
	/**
	...
	public void startEntity() {
		...
		//if(firstSubmitCloudlet) {//wang
			updateVmsThreatScore();//wang
		//	firstSubmitCloudlet = false;//wang
		//}
	}
