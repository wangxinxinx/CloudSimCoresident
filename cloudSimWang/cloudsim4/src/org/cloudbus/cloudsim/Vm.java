...
public class Vm {
	...
	private double startTimeInCurHost;//wang
	private int drlUserId;//wang
	
	//wang
	public double getStartTimeInCurHost() {
		return startTimeInCurHost;
	}

	//wang
	public void setStartTimeInCurHost(double startTimeInCurHost) {
		this.startTimeInCurHost = startTimeInCurHost;
	}

	//wang
	public int getDrlUserId() {
		return drlUserId;
	}

	//wang
	public void setDrlUserId(int drlUserId) {
		this.drlUserId = drlUserId;
	}
